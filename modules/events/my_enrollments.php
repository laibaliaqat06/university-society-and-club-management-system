            ...
            <?php if (empty($myEnrollments)): ?>
                <div class="col-12 text-center py-5">
                    <div class="glass-card p-5 d-inline-block">
                        ...
                        <a href="<?= BASE_URL ?>modules/events/index.php" class="btn btn-premium px-5 mt-3">Explore Events</a>
                    </div>
                </div>
            <?php else: ?>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card glass-card h-100 border-0 shadow-lg overflow-hidden hvr-float">
                            ...
                            <div class="card-footer bg-transparent border-top border-white border-opacity-10 p-4">
                                <a href="<?= BASE_URL ?>modules/events/view.php?id=<?= $en['event_id'] ?>" class="btn btn-outline-light w-100 fw-bold">View Event Details</a>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
