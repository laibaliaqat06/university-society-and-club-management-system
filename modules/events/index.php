                    ...
                    <div class="card h-100 border-0 shadow-lg bg-dark text-white overflow-hidden pill-container" style="border-radius: 12px; background: #2b3035 !important;">
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="mt-auto pt-3 border-top border-secondary text-white-50 small">
                                ...
                                <a href="<?= BASE_URL ?>modules/events/view.php?id=<?= $event['id'] ?>" class="btn btn-outline-light w-100 rounded-3">Get Details</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="card glass-card border-0 py-5 text-center shadow-lg">
                        <div class="card-body">
                            ...
                            <h3 class="fw-bold text-white mb-2">No Upcoming Events</h3>
                            <p class="text-white-50 mx-auto mb-4" style="max-width: 400px;">
                                The campus is quiet for now. Check back soon for workshops, competitions, and society meetups!
                            </p>
                            <a href="<?= BASE_URL ?>modules/clubs/index.php" class="btn btn-premium rounded-pill px-5">Join a Society</a>
                        </div>
                    </div>
                </div>
            <?php endif; ?>
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="card h-100 border-0 shadow-sm bg-dark text-white overflow-hidden" style="border-radius: 12px; background: #212529 !important; border: 1px solid rgba(255,255,255,0.05) !important;">
                            <div class="card-body p-3 d-flex flex-column">
                                ...
                                <?php endif; ?>
                                <a href="<?= BASE_URL ?>modules/events/view.php?id=<?= $event['id'] ?>" class="btn btn-sm btn-outline-light w-100 rounded-pill mt-auto">View Gallery</a>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
