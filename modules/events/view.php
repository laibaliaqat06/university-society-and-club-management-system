            ...
            <div class="card glass-card border-0 shadow-lg p-4 sticky-top" style="top: 100px;">
                ...
                <?php else: ?>
                    <div class="text-center py-3">
                        ...
                        <a href="<?= BASE_URL ?>modules/login.php" class="btn btn-primary w-100">Login Now</a>
                    </div>
                <?php endif; ?>
                ...
                <div class="mt-4 pt-4 border-top border-white border-opacity-10 text-center">
                    ...
                    <a href="<?= BASE_URL ?>modules/clubs/view.php?id=<?= $event['club_id'] ?>" class="btn btn-link btn-sm text-primary">View Club Profile</a>
                </div>
            </div>
        </div>
    </div>
