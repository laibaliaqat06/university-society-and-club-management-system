        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4">
                <div class="glass-card p-4 mb-4">
                    ...
                    <a href="<?= BASE_URL ?>modules/messages/index.php?id=<?= $club['created_by'] ?>" class="btn btn-premium w-100 rounded-pill mt-2">
                        <i class="bi bi-chat-dots-fill me-2"></i> Message Society Head
                    </a>
                </div>
                                ...
                                <div class="list-group-item bg-transparent border-white border-opacity-10 px-0 py-3 d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="d-flex align-items-center justify-content-between mb-1">
                                            <a href="<?= BASE_URL ?>modules/profile.php?id=<?= $member['id'] ?>" class="text-white small fw-bold text-decoration-none">
