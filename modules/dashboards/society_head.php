...
<div class="row g-4">
    ...
    <div class="col-lg-6 col-12">
        <div class="small-box text-bg-purple"> 
            ...
            <a href="<?= BASE_URL ?>modules/clubs/mysociety.php" class="small-box-footer">Manage <i class="bi bi-arrow-right-circle"></i></a>
        </div>
    </div>
    ...
    <div class="col-lg-6 col-12">
        <div class="small-box text-bg-orange">
            ...
            <a href="<?= BASE_URL ?>modules/events/manage.php" class="small-box-footer">Manage Events <i class="bi bi-arrow-right-circle"></i></a>
        </div>
    </div>
</div>
...
<div class="card card-outline card-warning mt-4">
    ...
    <div class="card-body">
        ...
        <ul>
            ...
            <li>Post announcements and <a href="<?= BASE_URL ?>modules/events/manage.php" class="text-warning fw-bold">Event Gallery</a> images.</li>
