    ...
    <div class="card-body position-relative d-flex align-items-center p-5 h-100">
        <div>
            ...
            <div class="d-flex align-items-center justify-content-between">
                ...
                <a href="<?= BASE_URL ?>modules/dashboards/member_id_card.php" class="btn btn-premium rounded-pill px-4 py-2 ms-4">
                    <i class="bi bi-person-badge me-2"></i> Digital ID
                </a>
            </div>
        </div>
    </div>
...
<div class="row g-4 mb-5">
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card glass-card border-0">
            ...
            <a href="<?= BASE_URL ?>modules/clubs/mysociety.php" class="stretched-link"></a>
        </div>
    </div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card glass-card border-0">
            ...
            <a href="<?= BASE_URL ?>modules/events/index.php" class="stretched-link"></a>
        </div>
    </div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card glass-card border-0">
            ...
            <a href="<?= BASE_URL ?>modules/events/my_enrollments.php" class="stretched-link"></a>
        </div>
    </div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card glass-card border-0">
            ...
            <a href="<?= BASE_URL ?>modules/events/volunteers.php" class="stretched-link"></a>
        </div>
    </div>
</div>
...
<div class="row g-4">
    ...
    <div class="col-lg-8">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="<?= BASE_URL ?>modules/clubs/index.php" class="btn btn-sm btn-outline-secondary rounded-pill">View All</a>
        </div>
        <div class="row g-3">
            <?php foreach($discoverClubs as $club): ?>
                <div class="col-md-6 col-xl-4">
                    <div class="card glass-card h-100 border-0 p-3">
                        ...
                        <a href="<?= BASE_URL ?>modules/clubs/view.php?id=<?= $club['id'] ?>" class="btn btn-sm btn-outline-primary w-100">Explore</a>
                    </div>
                </div>
            <?php endforeach; ?>
        </div>
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 mt-5">
            ...
            <a href="<?= BASE_URL ?>modules/events/index.php" class="btn btn-sm btn-outline-secondary rounded-pill">View All</a>
        </div>
        <div class="row g-3">
                ...
                <div class="col-md-12">
                    <div class="card glass-card border-0 p-3">
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto">
                                <a href="<?= BASE_URL ?>modules/events/view.php?id=<?= $event['id'] ?>" class="btn btn-sm btn-premium rounded-pill px-4">Enroll Now</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <?php else: ?>
                <div class="list-group list-group-flush">
                    <?php foreach($myCertificates as $cert): ?>
                        <a href="<?= BASE_URL ?>modules/certificates/generate.php?event_id=<?= $cert['event_id'] ?>&user_id=<?= $_SESSION['user_id'] ?>" target="_blank" class="list-group-item bg-transparent border-secondary border-opacity-10 px-0 py-3 d-flex align-items-center text-decoration-none">
