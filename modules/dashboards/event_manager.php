...
<div class="row">
    ...
    <div class="col-lg-4 col-12">
        <div class="small-box text-bg-maroon">
            ...
            <a href="<?= BASE_URL ?>modules/events/manage.php" class="small-box-footer">Track Attendance <i class="bi bi-arrow-right-circle"></i></a>
        </div>
    </div>
    ...
    <div class="col-lg-4 col-12">
        <div class="small-box text-bg-warning">
            ...
            <a href="<?= BASE_URL ?>modules/events/manage.php" class="small-box-footer text-dark">Review Applications <i class="bi bi-arrow-right-circle text-dark"></i></a>
        </div>
    </div>
</div>
