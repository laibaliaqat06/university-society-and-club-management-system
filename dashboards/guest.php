...
<div class="app-content">
    <div class="container-fluid">
        ...
        <div class="hero-section text-center position-relative">
            ...
            <div class="position-relative" style="z-index: 1;">
                ...
                <div class="d-flex justify-content-center gap-3">
                    <a href="<?= BASE_URL ?>register.php" class="btn btn-premium btn-lg px-5 py-3 fw-bold rounded-pill">
                        Join the Community <i class="bi bi-arrow-right-short ms-2"></i>
                    </a>
                    <a href="<?= BASE_URL ?>login.php" class="btn btn-outline-light btn-lg px-5 py-3 fw-bold rounded-pill">
                        Member Login
                    </a>
                </div>
            </div>
                    ...
                    <?php foreach($publicEvents as $e): ?>
                        <div class="card event-card-mini p-3 mb-3 border-0">
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto">
                                    <a href="<?= BASE_URL ?>login.php" class="btn btn-sm btn-outline-primary rounded-pill px-3">View Details</a>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
        ...
        <div class="text-center py-5 mt-5">
            ...
            <a href="<?= BASE_URL ?>register.php" class="btn btn-premium btn-lg px-5 py-3 rounded-pill fw-bold hvr-grow">Get Started Today for Free</a>
        </div>
    </div>
</div>
